package ru.itis.dis403.lab_05.filter;
...
import ru.itis.dis403.lab_05.controller.LoginServlet;
...
public class AuthFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        if (!checkExcluded(((HttpServletRequest)request).getServletPath()) &&
            ...
            ((HttpServletResponse) response).sendRedirect("/lab_05/login");
        } else {

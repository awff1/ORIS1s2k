package ru.itis.dis403.lab_07.controllers;
...
import ru.itis.dis403.lab_07.repositories.StreetRepository;
...
public class StreetServlet extends HttpServlet {
    ...
    public void init() {
        ...
        streetRepository = (StreetRepository) context.getAttribute("streetRepository");
    }
